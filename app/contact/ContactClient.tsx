...
const contactMethods = [
  ...
  },
  {
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round">
        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12.72 19.79 19.79 0 0 1 1.62 4.18 2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z"/>
      </svg>
    ),
    label: "Call / WhatsApp",
    value: "+91 91065 79181",
  ...
  },
  {
    ...
    href: "https://maps.google.com/?q=Godhra,Gujarat,India",
    sub: "Remote-friendly across India",
  },
];
...
const faqs = [
  ...
  { q: "What happens after I submit this form?", a: "We review your brief, then reach out to schedule a 30-minute discovery call. That's it — no cold pitch, no lengthy process." },
];
...
export default function ContactClient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate API call — wire up to your backend / Resend / Formspree
    ...
    <>
      ...
      <div ref={pageRef}>
        ...
        <main>
          ...
          {/* ── HERO ──────────────────────────────────────────────────────── */}
          <section
            className="contact-hero relative overflow-hidden pt-16"
            style={{ background: "var(--bg-primary)" }}
          >
            <div
              className="contact-glow absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none"
            ...
            <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-20">
              {/* Top: headline + contact methods side by side */}
              <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12 pb-16" style={{ borderBottom: "1px solid var(--border)" }}>
                ...
                <div className="max-w-xl">
                  <div
                    className="contact-eyebrow inline-flex items-center gap-2 rounded-full px-4 py-1.5 mb-8"
                  ...
                  <h1 className="contact-h1 font-syne font-extrabold leading-[0.92] tracking-tight mb-5">
                    <span className="block text-[clamp(44px,8vw,88px)]" style={{ color: "var(--fg-primary)" }}>
                      Start something
                    </span>
                    <span className="block text-[clamp(44px,8vw,88px)]" style={{ color: "var(--orange)" }}>
                      great.
                    </span>
                  </h1>
                  ...
                  {contactMethods.map((m) => (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <div className="text-[10px] font-medium tracking-[0.08em] uppercase mb-0.5" style={{ color: "var(--fg-faint)" }}>
                          {m.label}
                        </div>
                        <div className="text-[13px] font-medium truncate" style={{ color: "var(--fg-primary)" }}>
                          {m.value}
                        </div>
                        <div className="text-[11px] font-light" style={{ color: "var(--fg-muted)" }}>
                          {m.sub}
                        </div>
                      </div>
              ...
              <div className="flex flex-wrap gap-0 py-6">
                {[
                  ...
                  { n: "04", t: "Proposal",       d: "Fixed quote with timeline. You decide." },
                ].map((step, i) => (
                  <div
                    key={step.n}
                    className="flex-1 min-w-[160px] flex gap-3 px-4 py-2"
                    style={{ borderRight: i < 3 ? "1px solid var(--border)" : "none" }}
                  >
                    <span className="font-syne font-extrabold text-[11px] mt-0.5 flex-shrink-0" style={{ color: "var(--orange)", opacity: 0.6 }}>
                      {step.n}
                    </span>
                    <div>
                      <div className="font-syne font-extrabold text-[12px] mb-0.5" style={{ color: "var(--fg-primary)" }}>
                        {step.t}
                      </div>
                      <div className="text-[11px] font-light leading-snug" style={{ color: "var(--fg-faint)" }}>
                        {step.d}
                      </div>
                    </div>
                  </div>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              <div className="flex flex-col lg:flex-row gap-10">
                ...
                <div className="contact-form-wrap flex-1 min-w-0">
                  {formState === "success" ? (
                    <div
                      className="success-block rounded-2xl p-10 flex flex-col items-center justify-center text-center min-h-[500px]"
                      style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }}
                    >
                      {/* Animated checkmark */}
                      <div
                      ...
                      <div className="flex flex-wrap gap-3 justify-center">
                        <Link
                          href="/"
                          className="text-[13px] font-medium px-5 py-2.5 rounded-lg transition-all hover:scale-[1.03]"
                        ...
                        <Link
                          href="/services"
                          className="text-[13px] font-light px-5 py-2.5 rounded-lg transition-all hover:scale-[1.02]"
                    ...
                    >
                      ...
                      >
                        <div>
                          <div className="font-syne font-extrabold text-[16px] tracking-tight" style={{ color: "var(--fg-primary)" }}>
                            Project brief
                          </div>
                          <div className="text-[11px] font-light mt-0.5" style={{ color: "var(--fg-faint)" }}>
                            Takes about 3 minutes · All fields help us prepare better
                          </div>
                        </div>
                        <div
                          className="flex items-center gap-1.5 text-[10px] font-medium px-3 py-1.5 rounded-full"
                      ...
                      <div className="p-7 grid grid-cols-1 md:grid-cols-2 gap-5">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {budgets.map((b) => (
                              <button
                                ...
                                style={{
                                  background: formData.budget === b ? "var(--orange)" : "var(--bg-tertiary)",
                                  border: `1px solid ${formData.budget === b ? "var(--orange)" : "var(--border)"}`,
                                  color: formData.budget === b ? "white" : "var(--fg-muted)",
                                }}
                              >
                                {b}
                              </button>
                        ...
                        <div className="md:col-span-2">
                          ...
                          <textarea
                            required
                            rows={5}
                            placeholder="What are you building? What's the goal? Any specific requirements, timeline, or context that helps us understand what you need..."
                          ...
                          <div className="flex justify-between mt-1.5">
                            <span className="text-[10px]" style={{ color: "var(--fg-faint)" }}>
                              The more detail, the better we can prepare for the call.
                            </span>
                            <span className="text-[10px]" style={{ color: formData.message.length > 500 ? "var(--orange)" : "var(--fg-faint)" }}>
                        ...
                        <div className="md:col-span-2 flex items-center justify-between gap-4 flex-wrap">
                          ...
                          <button
                            ...
                            style={{
                              background: formState === "submitting" ? "var(--orange-hover)" : "var(--orange)",
                              opacity: formState === "submitting" ? 0.8 : 1,
                            }}
                            onMouseEnter={(e) => {
                ...
                <div className="flex flex-col gap-5 lg:w-72 flex-shrink-0">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className="w-12 h-12 rounded-xl flex items-center justify-center font-syne font-extrabold text-[16px] flex-shrink-0"
                        style={{ background: "var(--orange-bg)", border: "1px solid var(--orange-border)", color: "var(--orange)" }}
                      >
                        M
                      </div>
                      <div>
                        <div className="font-syne font-extrabold text-[14px]" style={{ color: "var(--fg-primary)" }}>
                          Mustafa Bhikhapur
                        </div>
                        <div className="text-[11px] font-light" style={{ color: "var(--fg-faint)" }}>
                          Founder · NDD.Studio
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="font-syne font-extrabold text-[22px]" style={{ color: "var(--fg-primary)" }}>
                      &lt; 24 hours
                    </div>
                    <div className="text-[11px] font-light mt-1" style={{ color: "var(--fg-muted)" }}>
                      Usually same day. Always by next morning.
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }}
                  >
                    <div className="text-[10px] font-medium tracking-[0.1em] uppercase mb-4" style={{ color: "var(--fg-faint)" }}>
                      What happens next
                    </div>
                  ...
                  <div
                    ...
                    style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }}
                  >
                    <div className="text-[10px] font-medium tracking-[0.1em] uppercase mb-3" style={{ color: "var(--fg-faint)" }}>
                      Prefer to reach out directly?
                    </div>
                    <div className="flex flex-col gap-2">
                      <a
                        href="https://wa.me/919106579181?text=Hi%20Mustafa%2C%20I%27d%20like%20to%20discuss%20a%20project%20with%20NDD%20Studio."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 p-3 rounded-lg text-[12px] font-medium transition-all duration-200 hover:scale-[1.02]"
          ...
          <section className="py-20" style={{ background: "var(--bg-primary)", borderTop: "1px solid var(--border)" }}>
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
              ...
              <h2 className="font-syne font-extrabold text-[clamp(24px,3.5vw,40px)] tracking-tight leading-[1] mb-10" style={{ color: "var(--fg-primary)" }}>
                ...
                <span style={{ color: "var(--fg-muted)" }}>work with NDD.Studio.</span>
              </h2>
              ...
              <div className="why-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <div
                    key={w.title}
                    className="why-card rounded-xl p-5 transition-all duration-300"
                    style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }}
                    onMouseEnter={(e) => {
                  ...
                  >
                    ...
                    <div className="font-syne font-extrabold text-[14px] mb-1.5" style={{ color: "var(--fg-primary)" }}>
                      {w.title}
                    </div>
                    <div className="text-[12px] font-light leading-relaxed" style={{ color: "var(--fg-muted)" }}>
                      {w.desc}
                    </div>
                  </div>
                ))}
          ...
          <section className="py-20" style={{ background: "var(--bg-secondary)", borderTop: "1px solid var(--border)" }}>
            <div className="max-w-3xl mx-auto px-6 lg:px-8">
              <p className="text-[10px] font-medium tracking-[0.16em] uppercase mb-2" style={{ color: "var(--orange)" }}>
                Quick answers
              </p>
              ...
              <div className="contact-faq-list flex flex-col">
                {faqs.map((faq, i) => (
                  ...
                  >
                    ...
                    >
                      <p className="text-[12px] font-light leading-relaxed pb-4" style={{ color: "var(--fg-muted)" }}>
                        {faq.a}
                      </p>
                    </div>
                  </div>
